...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'mooc', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\moocApp\\MoocBundle\\Entity'))), 'moocApp\\MoocBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('MoocBundle' => 'moocApp\\MoocBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_27c2c4e38fd8abe9933f7cde9277ef46009d1bfacb73fdcd6d9d0f62ecfbc7b6');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('moocApp\\MoocBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('swiftmailersymfony@gmail.com' => 'ghada chebbi'), 'resetting' => array('webmaster@example.com' => 'webmaster'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('moocApp\\MoocBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('moocApp\\MoocBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('moocApp\\MoocBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'moocApp\\MoocBundle\\Entity\\User');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \moocApp\MoocBundle\Redirection\AfterDeniedRedirection A moocApp\MoocBundle\Redirection\AfterDeniedRedirection instance.
     */
    protected function getRedirect_After_DeniedService()
    {
        return $this->services['redirect.after.denied'] = new \moocApp\MoocBundle\Redirection\AfterDeniedRedirection($this->get('router'), $this->get('security.context'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \moocApp\MoocBundle\Redirection\AfterLoginRedirection A moocApp\MoocBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \moocApp\MoocBundle\Redirection\AfterLoginRedirection($this->get('router'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \moocApp\MoocBundle\Redirection\AfterLogoutRedirection A moocApp\MoocBundle\Redirection\AfterLogoutRedirection instance.
     */
    protected function getRedirect_After_LogoutService()
    {
        return $this->services['redirect.after.logout'] = new \moocApp\MoocBundle\Redirection\AfterLogoutRedirection($this->get('router'), $this->get('security.context'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/organisme/register');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/apprenant/');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/organisme/');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/afficherCompte');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/detailCompte');
        ...
        $p->add($l, array(0 => 'ROLE_APPRENANT'), NULL);
        $p->add($m, array(0 => 'ROLE_ORGANISME'), NULL);
        $p->add($n, array(0 => 'ROLE_ADMIN'), NULL);
        $p->add($o, array(0 => 'ROLE_ADMIN'), NULL);

        $q = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $r = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $q, $this->get('redirect.after.logout'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($p, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => $r, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $q, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('redirect.after.login'), array('login_path' => '/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'main'), $s, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '56ce2573d80281.47789257', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $p, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $q, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $q, '/login', false), NULL, $this->get('redirect.after.denied'), $a));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\moocApp\\MoocBundle/Resources/views'), 'Mooc');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \moocApp\MoocBundle\Form\RegistrationFormType A moocApp\MoocBundle\Form\RegistrationFormType instance.
     */
    protected function getUser_Registration_FormService()
    {
        return $this->services['user.registration.form'] = new \moocApp\MoocBundle\Form\RegistrationFormType('moocApp\\MoocBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_APPRENANT' => array(0 => 'ROLE_USER'), 'ROLE_ORGANISME' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MoocBundle' => 'moocApp\\MoocBundle\\MoocBundle',
            ...
            'security.role_hierarchy.roles' => array(
                'ROLE_APPRENANT' => array(
                    0 => 'ROLE_USER',
                ),
                'ROLE_ORGANISME' => array(
                    0 => 'ROLE_USER',
                ),
            ...
            'fos_user.model.user.class' => 'moocApp\\MoocBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'swiftmailersymfony@gmail.com' => 'ghada chebbi',
            ),
